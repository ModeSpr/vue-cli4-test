...
(function (root, factory) {
  ...
  else if (typeof exports === 'object') exports.Zoom = factory()
  else root.Zoom = factory()
})(this, function () {
  /**
   * 简洁的元素缩放功能。
  ...
  Zoom.prototype.preSetScale = function (scale, pointX, pointY) {
    ...
    if (pointX == undefined) {
      this.left =
        this.centerX - this.originW / 2 - (this.originW / 2) * (scale - 1)
      this.top =
        this.centerY - this.originH / 2 - (this.originH / 2) * (scale - 1)
